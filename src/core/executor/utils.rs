...
impl SQLExecutor {
    ...
    /// * `executor_state` - Current executor state containing SQL text
    ///
    /// # Returns
    ...
    pub(super) fn get_content_from_span(
        &self,
        ...
        let sql_line = executor_state.sql_statements.lines().nth(line - 1)?;
